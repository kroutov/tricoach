...
- **Calendrier limité à la semaine courante, sans navigation** : corrigé post-lancement — voir "Post-lancement" dans [`tricoach-web/README.md`](tricoach-web/README.md#statut).
